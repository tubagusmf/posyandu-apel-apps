                        ...
                        <div class="col-12 col-md-8">
                            <div class="tab-content" id="v-pills-with-icon-tabContent">                                
                                <div class="tab-pane fade show active" id="v-pills-profile-icons" role="tabpanel" aria-labelledby="v-pills-profile-tab-icons">
                                    ...
                                    <table class="table table-hover">
                                        <tr>
                                          <th>NIK</th>
                                          <td>:</td>
                                          <td>{{ $profile->nik_kader }}</td>
                                        </tr>
                                        <tr>
                                          <th>Nama</th>
                                          <td>:</td>
                                          <td>{{ $profile->nama_kader }}</td>
                                        </tr>
                                        <tr>
                                          <th>Username</th>
                                          <td>:</td>
                                ...
                                <div class="tab-pane fade" id="v-pills-home-icons" role="tabpanel" aria-labelledby="v-pills-home-tab-icons">
                                    ...
                                    <form action="{{ route('kader.profile-kader.update') }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                    
                                        <div class="form-group">
                                          <label>NIK Kader</label>
                                          <input type="text" class="form-control" value="{{ $profile->nik_kader }}" disabled>
                                        </div>
                                    
                                        <div class="form-group">
                                          <label>Nama Kader</label>
                                          <input type="text" name="nama_kader" class="form-control" value="{{ old('nama_kader', $profile->nama_kader) }}">
                                        </div>
