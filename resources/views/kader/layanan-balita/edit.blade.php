              ...
              <div class="row">
                ...
                <form action="{{ route('kader.layanan-balita.update', $layananBalita->id) }}" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="imunisasi" class="form-control" rows="3" required>{{ $layananBalita->imunisasi }}</textarea>
                  </div>
                  <div class="form-group">
                    <label for="tgl_imunisasi">Tanggal Imunisasi</label>
                    <input type="date" name="tgl_imunisasi" class="form-control" value="{{ $layananBalita->tgl_imunisasi }}" required>
                  </div>
                  <div class="form-group">
